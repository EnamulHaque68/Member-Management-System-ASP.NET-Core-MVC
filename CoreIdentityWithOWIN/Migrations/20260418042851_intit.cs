...
namespace CoreIdentityWithOWIN.Migrations
{
    /// <inheritdoc />
    public partial class intit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberTypes", x => x.TypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegFee = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    TypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_MemberTypes_TypeId",
                        column: x => x.TypeId,
